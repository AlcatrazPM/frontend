	...
	Widget build(BuildContext context) {
		...
		return Column(
			...
			children: <Widget>[
				...
				// Master Password
				Padding(
				  padding: const EdgeInsets.only(left: 8.0, top: 15.0, right: 400.0, bottom: 8.0),
				...
				Row(
					children: <Widget>[
						...
						Expanded(
							flex: 1,
						  child: Padding(
						  	padding: const EdgeInsets.only(left: 8.0, top: 8.0, right: 25.0, bottom: 8.0),
						...
						Expanded(
						  ...
						  child: Padding(
							  padding: const EdgeInsets.only(left: 8.0, top: 8.0, right: 25.0, bottom: 8.0),
						  	child: DataField('Confirm New Master Password', _confirmNewMasterPassword),
						  ),
						),
					],
				),
