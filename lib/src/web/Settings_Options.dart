...
class _OptionsSettingsState extends State<OptionsSettings> {
	...
	void initState() {
		...
		listLockTime.add(DropdownMenuItem<LockTime>(value: LockTime.OneMin, child: Text("One Minute")));
		listLockTime.add(DropdownMenuItem<LockTime>(value: LockTime.TwoMin, child: Text("Two Minutes")));
		listLockTime.add(DropdownMenuItem<LockTime>(value: LockTime.ThreeMin, child: Text("Three Minutes")));

		_selectedAlgo = getUserSelectedAlgo();
		listCriptoType = new List<DropdownMenuItem<CriptoType>>();
		listCriptoType.add(DropdownMenuItem<CriptoType>(value: CriptoType.DaCuZaru, child: Text("Da Cu Zaru"),));
		listCriptoType.add(DropdownMenuItem<CriptoType>(value: CriptoType.DaCuBanu, child: Text("Da Cu Banu"),));
		listCriptoType.add(DropdownMenuItem<CriptoType>(value: CriptoType.RandomOrg, child: Text("Random Punct Org"),));
...
//  }
	...
	Widget createKDF( func(var x), var value, List itms, String titleAlgo, String titleIterations, TextEditingController _control) {
		return Padding(
			padding: EdgeInsets.all(leftPadding),
			child: Row(
				children: <Widget>[
	...
	Widget DataField(String title, TextEditingController _controller, bool isPassword) {
